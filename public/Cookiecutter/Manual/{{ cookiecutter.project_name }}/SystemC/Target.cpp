...
void Target::b_transport(tlm::tlm_generic_payload &trans, sc_core::sc_time &t)
{
    ...
    auto image = imread("./image_samples/img_1.jpg", cv::ImreadModes::IMREAD_GRAYSCALE);//E:/Github/Siemens-System-Level-Modelling-of-ASDLA-Graduation-Project/examples/SystemC_Ctorch/build2/image_samples/img_1.jpg
    // Use show image to show the read image
    showImage(image);

    auto module = torch::jit::load("./Pt/model.pt");//"E:/Github/Siemens-System-Level-Modelling-of-ASDLA-Graduation-Project/data/result/model5.pt");

    cout << endl << " rows" << image.rows << endl;
    auto tensor_image = torch::from_blob(image.data, {1, 3, 28, 28}, torch::kByte);
